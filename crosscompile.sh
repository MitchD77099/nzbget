...
export CFLAGS="-march=${ARCH} -mcpu=marvell-pj4 -mfpu=vfpv3-d16 -mfloat-abi=softfp --include-dir=/home/drobo/xtools/toolchain/5n/arm-marvell-linux-gnueabi/libc/thumb2/usr/include/bits/"
