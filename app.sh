...
make CXX="${CXX}" CXXFLAGS="${CFLAGS} -I/home/drobo/xtools/toolchain/arm-drobo_x86_64-linux-gnueabi/arm-drobo_x86_64-linux-gnueabi/include/ -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE" STRIP="${STRIP}" LDFLAGS="${LDFLAGS} -pthread"
